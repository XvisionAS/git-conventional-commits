module.exports = function(config) {
  ...
  this.generateMarkdown = function(firstChangelogCommit, lastChangelogCommit, release, conventionalCommits, customMarkdown, date = new Date()) {
    ...
    changelogMarkdown += `## **${yyyy_mm_dd(date)}** (${changelogCommitRangeMarkdown})\n`;
